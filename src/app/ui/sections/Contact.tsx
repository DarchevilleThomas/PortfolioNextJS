                ...
                <form action="https://formspree.io/f/mzblkaok" method="POST" className="flex-1 max-w-[80%] md:max-w-3xl mx-auto space-y-8">
                    <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
                        <input
                            ...
                            className="w-full md:w-1/2 p-4 rounded-lg border border-dark focus:outline-none focus:ring-2 focus:ring-primary bg-dark"
                            required
                        />
                        <input
                            type="email"
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
                        <input
                            ...
                            className="w-full md:w-1/2 p-4 rounded-lg border border-dark focus:outline-none focus:ring-2 focus:ring-primary bg-dark spinner"
                        />
                        <input
                            type="text"
                            name="objet"
                    ...
                    <textarea
                        ...
                        className="w-full p-4 rounded-lg border border-dark focus:outline-none focus:ring-2 focus:ring-primary bg-dark resize-none"
                        required
                    ></textarea>
